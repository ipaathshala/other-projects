            ...
            <form class="form-horizontal m-t-30">
              ...
              <div class="form-group row m-t-20">
                <div class="col-12 text-right">
                  ...
                  <button class="btn btn-primary w-md waves-effect waves-light" type="submit" name="submit">Login</button>
                </div>
              </div>
              <div class="form-group row m-t-20">
                <div class="col-12">
					...
					<div class="alert alert-danger bg-danger text-white" role="alert" id="invlogin">Invalid login details</div>
