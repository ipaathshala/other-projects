            ...
            <form class="form-horizontal m-t-30">
              ...
              <div class="form-group row m-t-20">
                ...
                <div class="col-12 text-center">
                  <br>
                  <p>Already have an account? <a href="index" class="text-primary">Sign In</a></p>
                </div>
              </div>
              <div class="form-group row m-t-20">
                <div class="col-12">
                  ...
                  <div class="alert alert-danger bg-danger text-white" role="alert" id="duplicate">Email already exist in the system</div>
                  <div class="alert alert-danger bg-danger text-white" role="alert" id="invalid">Some error occurs unable to register</div>
                  <div class="alert alert-danger bg-danger text-white" role="alert" id="fail">Something goes wrong unable to proceed request</div>
                  <div class="alert alert-success bg-success text-white" role="alert" id="success">Success! you account created succesfully</div>
                </div>
              </div>
            </form>
          </div>
