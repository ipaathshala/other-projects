      ...
      <div class="header__top-area black-bg">
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
              <div class="header__top-menu  text-md-right">
                <ul>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-3 d-flex align-items-center justify-content-md-start justify-content-center">
              <div class="header__logo text-center text-md-left mb-20">
                <a href="index.html"><img src="assets/img/logo/logo.png" alt="Header Logo"></a>
              </div>
            </div>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul class="submenu">
                        ...
                        <li><a href="post-details.html">BLog Details</a></li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul class="submenu">
                        ...
                        <li><a href="portfolio-full.html">Portfolio Box</a>
                        </li>
                      </ul>
                    </li>
                    <li>
    ...
    <main>
      ...
      <section class="hero-area">
        <div class="slider-active slider-arrow">
                  ...
                  <div class="slider pb-60">
                    <div class="slider__text">
                      ...
                      <h3 class="mb-15" data-animation="fadeInUp" data-delay=".4s">
                        <a href="#">Presidential Hopefuls Are Using Hamptons Raise Big Bucks</a>
                      </h3>
          ...
          <div class="single-slider slide-height d-flex align-items-end" data-overlay="dark-gradient" style="background-image: url(assets/img/hero/part2/slide2.jpg)">
            <div class="container">
              <div class="row">
                <div class="col-lg-7">
                  <div class="slider pb-60">
          ...
          <div class="single-slider slide-height d-flex align-items-end" data-overlay="dark-gradient" style="background-image: url(assets/img/hero/part2/slide3.jpg)">
            <div class="container">
              <div class="row">
                <div class="col-lg-7">
                  <div class="slider pb-60">
          ...
          <div class="single-slider slide-height d-flex align-items-end" data-overlay="dark-gradient" style="background-image: url(assets/img/hero/part2/slide4.jpg)">
            <div class="container">
              <div class="row">
                <div class="col-lg-7">
                  <div class="slider pb-60">
      ...
      <!-- breaking end -->
      <!-- news area -->
      <section class="cat-area pt-60 pb-60">
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="section-title mb-30">
                <h2><a href="#">Boards</a></h2>
              </div>
              <div class="postbox mb-25">
                <div class="postbox__thumb">
                  <img src="assets/img/cat/cat1.jpg" alt="hero image">
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="section-title mb-30">
                <h2><a href="#">Medical Entrances (UG)</a></h2>
              </div>
              <div class="postbox mb-25">
                <div class="postbox__thumb">
                  <img src="assets/img/cat/cat2.jpg" alt="hero image">
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 d-md-none d-lg-block">
              <div class="section-title mb-30">
                <h2><a href="#">Engineering Entrances</a></h2>
              </div>
              <div class="postbox mb-25">
                <div class="postbox__thumb">
                  <img src="assets/img/cat/cat3.jpg" alt="hero image">
                </div>
              </div>
            </div>
      ...
      <!-- latest news -->
      <!-- latest news end -->
      <section class="app-area pt-60 pb-60">
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-xl-6 col-lg-12">
                <div class="app-store text-center text-xl-right">
                  <a href="#"><img src="assets/img/store/apple.png" alt=""></a>
                  <a href="#"><img src="assets/img/store/google.png" alt=""></a>
                </div>
              </div>
            </div>
          </div>
