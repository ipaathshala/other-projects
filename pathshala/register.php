    ...
    <div class="register-box">
      ...
      <div class="register-box-body">
        <p class="login-box-msg text-danger">
          ...
          <small id="invpw">* Password do not match with confirm password</small>
          <small id="fail">* Oops something goes wrong unable to create your account</small>
          <small id="success" class="text-success">Congratulations your account created successfully</small>
        </p>
        <form method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Retype password" name="cpw" id="cpw" value="<?php echo $_POST['cpw'];?>">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-5">
